module.exports = {
  ...
  kickRequest: {
    ...
    ar: '‏$[1] يريد طرد $[2] من الدردشة. هل توافق؟',
  },
  kickAction: {
    uk: '🔫 Кікнути ($[1]/$[2])',
    en: '🔫 Kick ($[1]/$[2])',
  ...
  resultSave: {
    ...
    ar:
      '👼 ‏$[1] تم اغفاؤه — لا يوجد طرد لك هذه المرة.\n\nالمصوتون الذين اختاروا الغفران:\n$[2]',
  },
  resultKick: {
    uk:
    ...
    ar:
      '🔫 ‏$[1] تم طرده — الطرد الوحيد لهذا المستخدم هو إلغاء الحظر يدويًا من قبل المشرفين.\n\nالمصوتون الذين اختاروا الطرد:\n$[2]',
  },
  voteSave: {
  ...
  limitMessage: {
    ...
    ar:
      '✌️ ‏يرجى تحديد الحد الأدنى للأصوات لإزالة مستخدم. العدد الحالي هو *$[1]*',
  },
  limitSuccess: {
    uk:
  ...
  tooSoonError: {
    ...
    ar:
      '🔥 يبدو أنك تحاول بدء طلب حظر جديد قريبًا جدًا. يمكنك تغيير حد الوقت لطلبات الحظر باستخدام الأمر /time. شكرًا!',
  },
  timeLimitMessage: {
    en:
    ...
    ar:
      '✌️ يرجى تحديد الحد الأدنى للوقت بين طلبات الحظر. الحد الحالي هو *$[1]* ثانية.',
  },
  timeLimitSuccess: {
    en:
